...
module SDmoduleInit
    ...
    function Filter_SDs_dataframe(SD_df::DataFrame, comp::String = "left")
        ...
        for line in eachrow(SD_df)
            ...
            chr2 = line[:chr2]
            if comp == "left"
                if chr1 < chr2             # khm, compare strings
...
module CNVs_TCGA                                                           
    ...
    function read_CNVs_TCGA(file_CNVs::String = "../TCGA_CNV_data/CNVs_BRCA_all.txt", logthr::Float64 = 0.3)
        ...
        cnvs_df = DataFrame(chr = String[], coor_s = Int64[], coor_e = Int64[], copylog = Float64[])
        ...
        open(file_CNVs) do cnvfile
            ...
            chrs = map(x -> x in ["X", "Y"] ? "0" : x, chrs)        # X or Y are excluded here;
